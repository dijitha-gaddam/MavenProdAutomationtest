...
public class Prod_yarncheck 
{
	...
	Thread.sleep(6000);
	//Runtime.getRuntime().exec("C:\\Users\\dijitha\\Desktop\\Auto IT scripts\\PROD_TEST_YARN.exe");
driver.get("http://dijitha:Dijitha@123!@getbook.modjoul.com");
...
Reporter.log("Data pushed on prod environment and Streaming completed");
