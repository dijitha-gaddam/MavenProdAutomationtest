package MavenProdautomationtest.MavenProdautomationtest;
...
public class Prodemp_dashboard_test 
{
	...
	driver.get("https://dashboard.modjoul.com");
	driver.manage().window().maximize();
	driver.manage().timeouts().implicitlyWait(35,TimeUnit.SECONDS);
	System.out.println(driver.getTitle());
	driver.findElement(By.name("username")).sendKeys("401-perftest@mailinator.com");
	...
	Reporter.log("Username: 401-perftest@mailinator.com",true);
